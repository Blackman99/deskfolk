...
Ticket 11 consumes this shared drain for remote restart/stop without reimplementing admission. Window-supervised restart is the default; missing window plus no independent runtime remains unavailable. Physical UV and sealed-runtime gates stay unpassed. Full file upload/duplex, standalone launchd, push and independent audit remain separate.
