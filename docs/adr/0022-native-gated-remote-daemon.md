...
This ticket is not PWA, deployment, sealed-runtime or external security acceptance. Ticket 09 added host directory browse and duplex file streams; standalone supervision, maintenance and their physical/native release gates remain downstream. Local generated-key/socket/SQLite tests do not prove human UV, Keychain access-group provisioning, Docker/domain TLS, real TCC prompts or independent audit.
