-- The schema as it shipped before plans had a spec, tickets and spec revisions (main tree at the
-- time this was taken: git HEAD c54f632 plus the brief / check-back / closing-check work of 2026-09-25).
