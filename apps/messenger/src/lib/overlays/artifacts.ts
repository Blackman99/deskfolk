...
const SVG_UNSAFE_URL = /(?:xlink:href|href|src|values|to|from|begin|end)\s*=\s*(?:"\s*(?:javascript|data|vbscript):[^"]*"|'\s*(?:javascript|data|vbscript):[^']*'|(?:javascript|data|vbscript):[^\s>]+)/gi;
