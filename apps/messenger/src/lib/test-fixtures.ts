...
export function fakeRuntime(over: Partial<Snapshot> = {}, stubs: Record<string, unknown> = {}): FakeRuntime {
  ...
  const base = {
    ...
    annotationFileKeys: {},
    loadAnnotations: record("loadAnnotations"),
    createAnnotation: record("createAnnotation"),
    patchAnnotation: record("patchAnnotation"),
    deleteAnnotation: record("deleteAnnotation"),
    sendAnnotations: record("sendAnnotations"),
    hosted: false,
    enrolled: false,
    pairing: { phase: "scan" },
    pairingBusy: false,
    ...
    suggestComposer: record("suggestComposer"),
    dismissComposerSuggestions: record("dismissComposerSuggestions"),
